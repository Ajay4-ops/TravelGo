...
app = Flask(__name__)
app.secret_key = 'ajay123' # IMPORTANT: Change this to a strong, random key in production!
...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:253490788465:Travelgo:6fcf0ea6-9718-4d28-a208-aa42d72eebc1'  # Replace with actual SNS topic ARN
